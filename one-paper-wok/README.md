...
**产品预告片（MP4，约 47 秒，1080p）：** [docs/manual/一纸读书煲-产品预告.mp4](docs/manual/一纸读书煲-产品预告.mp4)

配乐：Kevin MacLeod《Crypto》《Light Awash》（incompetech.com，CC BY 3.0）。片中砂煲形象统一为煲仔饭那种砂煲；部分界面为宣传渲染，含尚未上线的「一纸搭子」「一纸食堂」。
